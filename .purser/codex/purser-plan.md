...
Codex does not provide repo-local slash commands. Use `purser prompt purser-plan --agent codex` to print this prompt, then paste or adapt it in your Codex session.
