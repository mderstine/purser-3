# Create or refine a project spec

Codex does not provide repo-local slash commands. Use `purser prompt purser-add-spec --agent codex` to print this prompt, then paste or adapt it in your Codex session.
